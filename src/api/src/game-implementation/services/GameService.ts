...
export class GameService extends BaseGameService<PlayerSession> {
    ...
    public constructor() {
        ...
        this.registerGameObject(LowerRightStoneItem);
        this.registerGameObject(UpperRightStoneItem);
        this.registerGameObject(LowerLeftStoneItem);
        this.registerGameObject(UpperLeftStoneItem);
